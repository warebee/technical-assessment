...
export const sections: Section[] = [
  {
    ...
    points: 15,
    description:
      "Testing comprehension of data relationships, schemas, and transformations",
  },
  {
    id: "B",
  ...
  },
  {
    ...
    points: 25,
    description:
      "LAG/LEAD, partitioning, session detection, and complex analytics",
  },
  {
    id: "D",
...
c) Which timestamp should be used for \`eventEndTime\` in the ActivityFeed and why?`,
  },
  {
    ...
    points: 5,
    type: "text",
    prompt: `The \`scan_code\` field contains values like \`PKL421303\` which need to be transformed to location format \`ABCD 42 13 03\`.
...
Given the location format transformation (PKL421303 → ABCD 42 13 03), write a query that:
...
export const activityFeedSchema = `// Target ActivityFeed Schema (required fields marked with *)
{
  ...
  locationId*: string,       // Format: "ABCD 42 13 03"
